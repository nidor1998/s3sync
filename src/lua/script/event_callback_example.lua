...
function on_event(event_data)
    ...
    elseif event_data.event_type == 1 << 15 then
        ...
        print("stats_etag_mismatch:", event_data.stats_etag_mismatch)
        print("stats_checksum_verified:", event_data.stats_checksum_verified)
        print("stats_checksum_mismatch:", event_data.stats_checksum_mismatch)
    ...
    print("source_content_type", event_data.source_content_type)
    print("source_user_defined_metadata", event_data.source_user_defined_metadata)
    print("source_tagging", event_data.source_tagging)
