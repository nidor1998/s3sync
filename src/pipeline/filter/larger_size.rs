...
fn is_larger_or_equal(object: &S3syncObject, config: &FilterConfig, _: &ObjectKeyMap) -> bool {
...
mod tests {
    ...
    async fn larger() {
        ...
        let object = S3syncObject::NotVersioning(Object::builder().size(6).build());
    ...
    async fn smaller() {
        ...
        let object = S3syncObject::NotVersioning(Object::builder().key("test").size(4).build());
