...
mod tests {
    ...
    #[test]
    fn with_custom_value_with_conflict_delete() {
        init_dummy_tracing_subscriber();
    ...
    #[test]
    fn with_custom_value_with_conflict_head_each_target() {
        init_dummy_tracing_subscriber();
    ...
    #[test]
    fn with_custom_value_with_conflict_remove_modified_filter() {
        init_dummy_tracing_subscriber();
    ...
    #[test]
    fn with_custom_value_with_conflict_sync_latest_tagging() {
        init_dummy_tracing_subscriber();
