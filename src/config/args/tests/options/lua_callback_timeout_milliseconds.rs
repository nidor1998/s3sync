...
mod tests {
    ...
    fn with_default_value() {
        ...
        assert_eq!(config.lua_callback_timeout_milliseconds, 10000);
    }
    ...
    fn with_custom_value() {
        ...
        assert_eq!(config.lua_callback_timeout_milliseconds, 5000);
    }
    ...
    fn with_zero_value() {
        ...
        assert_eq!(config.lua_callback_timeout_milliseconds, 0);
    }
