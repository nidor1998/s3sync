...
mod tests {
    ...
    async fn s3_to_s3_with_prefix_server_side_copy_all_metadata() {
...

        {
            ...
            helper
                .verify_test_object_metadata(&bucket2, "mydir/data1", None)
                .await;
        }
    ...
    async fn s3_to_s3_with_prefix_multipart_upload_server_side_copy_all_metadata() {
...

        {
            ...
            helper
                .verify_test_object_metadata(&bucket2, "mydir/large_file", None)
                .await;
        }
    ...
    async fn s3_to_s3_with_multipart_upload() {
...

        {
            ...
            assert!(
                helper
                    .verify_e_tag(&bucket2, "large_file", None, LARGE_FILE_S3_ETAG)
                    .await
            );
        }
    ...
    async fn s3_to_s3_metadata_test() {
...

        {
            ...
            helper
                .verify_test_object_metadata(&bucket2, "data1", None)
                .await;
        }
    ...
    async fn s3_to_s3_no_system_metadata_test() {
...

        {
            ...
            helper
                .verify_test_object_no_system_metadata(&bucket2, "data1", None)
                .await;
        }
    ...
    async fn s3_to_s3_no_user_defined_metadata_test() {
...

        {
            ...
            helper
                .verify_test_object_no_user_defined_metadata(&bucket2, "data1", None)
                .await;
        }
    ...
    async fn s3_to_s3_metadata_test_with_multipart_upload() {
...

        {
            ...
            helper
                .put_object_with_metadata(&bucket1, "data1", LARGE_FILE_PATH)
                .await;
        }
    ...
    async fn s3_to_s3_with_empty_directory() {
...

        {
            ...
            assert_eq!(
                helper
                    .head_object(&bucket2, "dir1/dir2/", None)
                    .await
                    .content_length()
                    .unwrap(),
                0
    ...
    async fn s3_to_s3_with_last_modified_metadata() {
...

        {
            ...
            let object = helper.get_object(&bucket2, "data1", None).await;
            assert!(
                object
                    .metadata
                    .unwrap()
    ...
    #[tokio::test]
    async fn s3_to_s3_server_side_copy_with_special_chars() {
        TestHelper::init_dummy_tracing_subscriber();
    ...
    #[tokio::test]
    async fn s3_to_s3_server_side_copy_with_special_chars_multipart() {
        TestHelper::init_dummy_tracing_subscriber();
...

        {
            ...
            TestHelper::create_large_file_with_special_characters();
            ...
            let args = vec![
                ...
                "--content-type",
                "application/pdf",
                LARGE_FILE_WITH_SPECIAL_CHARS_DIR,
                &target_bucket_url,
            ];
            let config = Config::try_from(parse_from_args(args).unwrap()).unwrap();
            let cancellation_token = create_pipeline_cancellation_token();
    ...
    #[tokio::test]
    async fn s3_to_s3_sync_annotation_without_prefix() {
        TestHelper::init_dummy_tracing_subscriber();
    ...
    #[tokio::test]
    async fn s3_to_s3_sync_annotation_dry_run_server_side_copy() {
        TestHelper::init_dummy_tracing_subscriber();
    ...
    #[tokio::test]
    async fn s3_to_s3_sync_annotation_with_prefix() {
        TestHelper::init_dummy_tracing_subscriber();
...

        {
            ...
            helper
                .put_test_object(&bucket1, "prefix/test_object", "test_object_content")
                .await;
            helper
                .put_test_object(&bucket1, "prefix/test_object2", "test_object_2_content")
                .await;
        ...
        let source_bucket_url = format!("s3://{}/prefix/", bucket1);
        let target_bucket_url = format!("s3://{}/prefix2/", bucket2);
    ...
    #[tokio::test]
    async fn s3_to_s3_sync_annotation_with_kms() {
        TestHelper::init_dummy_tracing_subscriber();
...

        {
            ...
            helper
                .put_test_object_kms(&bucket1, "prefix/test_object", "test_object_content")
                .await;
            helper
                .put_test_object_kms(&bucket1, "prefix/test_object2", "test_object_2_content")
                .await;
    ...
    #[tokio::test]
    async fn s3_to_s3_sync_annotation_with_sha256() {
        TestHelper::init_dummy_tracing_subscriber();
...

        {
            ...
            let annotation_value = helper
                .get_object_annotation(&bucket2, "prefix2/test_object", None, TEST_ANNOTATION_NAME)
                .await;
            assert_eq!(annotation_value, TEST_ANNOTATION_VALUE);
        }
    ...
    #[tokio::test]
    async fn s3_to_s3_sync_annotation_with_sync_latest() {
        TestHelper::init_dummy_tracing_subscriber();
...

        {
            ...
            let annotation_value = helper
                .get_object_annotation(&bucket2, "test_object", None, "test_annotation_name1")
                .await;
            assert_eq!(annotation_value, "test_annotation_value1_modified");
            let annotation_value = helper
                .get_object_annotation(&bucket2, "test_object", None, "test_annotation_name_added")
                .await;
            assert_eq!(annotation_value, "test_annotation_value_added");
            let is_annotation_exist = helper
                .is_object_annotation_exist(&bucket2, "test_object", None, "test_annotation_name2")
                .await;
            assert!(!is_annotation_exist);
    ...
    #[tokio::test]
    async fn s3_to_s3_sync_annotation_kms_with_sync_latest() {
        TestHelper::init_dummy_tracing_subscriber();
...

        {
            ...
            helper
                .put_test_object_kms(&bucket1, "test_object", "test_object_content")
                .await;
            helper
                .put_object_annotation(
                    &bucket1,
...

        {
            helper
                .put_object_annotation(
                    ...
                    None,
                    "test_annotation_name1",
                    "test_annotation_value1_modified2",
                    None,
                )
                .await;
            helper
...

        {
            ...
            let annotation_value = helper
                .get_object_annotation(&bucket2, "test_object", None, "test_annotation_name1")
                .await;
            assert_eq!(annotation_value, "test_annotation_value1_modified2");
        }
    ...
    #[tokio::test]
    async fn s3_to_s3_sync_annotation_with_sync_latest_dry_run() {
        TestHelper::init_dummy_tracing_subscriber();
    ...
    #[tokio::test]
    async fn s3_to_s3_sync_annotation_dry_run_case2() {
        TestHelper::init_dummy_tracing_subscriber();
    ...
    #[tokio::test]
    async fn s3_to_s3_sync_annotation_with_sync_latest_server_side_copy_dry_run() {
        TestHelper::init_dummy_tracing_subscriber();
    ...
    #[tokio::test]
    async fn s3_to_s3_sync_annotation_with_sync_latest_disable_etag_verification() {
        TestHelper::init_dummy_tracing_subscriber();
    ...
    #[tokio::test]
    async fn s3_to_s3_sync_annotation_server_side_copy() {
        TestHelper::init_dummy_tracing_subscriber();
    ...
    #[tokio::test]
    async fn s3_to_s3_sync_annotation_multipart_upload() {
        TestHelper::init_dummy_tracing_subscriber();
...

        {
            ...
            assert_eq!(annotation_value, "test_annotation_value1");
            let annotation_value = helper
                .get_object_annotation(&bucket2, "large_file", None, "test_annotation_name2")
                .await;
            assert_eq!(annotation_value, "test_annotation_value2");
        }
    ...
    #[tokio::test]
    async fn s3_to_s3_sync_annotation_multipart_upload_server_side_copy() {
        TestHelper::init_dummy_tracing_subscriber();
    ...
    #[tokio::test]
    async fn s3_to_s3_sync_annotation_multipart_upload_server_side_copy_no_annotation() {
        TestHelper::init_dummy_tracing_subscriber();
...

        {
            ...
            assert!(!is_annotation_exist);
            let is_annotation_exist = helper
                .is_object_annotation_exist(&bucket2, "large_file", None, "test_annotation_name2")
                .await;
            assert!(!is_annotation_exist);
        }
